...
class TestPersonalidadEysenck extends SMG_Controller {
	...
	public function encuesta()
	{
		...
		if($this->testPersonalidadEysenck->insertar_personalidad_eyenck($datos)){
			$datos_resultado = array(
				'extroversion'		=> "Extroversi&oacute;n: " . $datos['extroversion'],
				'introversion' 		=> "Introversi&oacute;n: " . $datos['introversion'],
				'estabilidad' 		=> "Estabilidad: " . $datos['estabilidad'],
				'inestabilidad' 	=> "Inestabilidad: " . $datos['inestabilidad'],
				'escaladementiras' 	=> "Escala de mentiras: " . $datos['escaladementiras'],
				'melancolico' 		=> "Melanc&oacute;lico: " . $datos['melancolico'],
				'colerico' 			=> "Col&eacute;rico: " . $datos['colerico'],
				'flematico' 		=> "Flem&aacute;tico: " . $datos['flematico'],
				'sanguineo' 		=> "Sangu&iacute;neo: " . $datos['sanguineo']
			);
		}else{
	         $datos_resultado = array();
		}
	...
	private function evaluar_test($p_datos, $p_limite_preguntas){
		...
		if($array_calculos['n'] >= 0 && $array_calculos['n'] <= 11){
